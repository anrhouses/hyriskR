---
title: 'HYRISK tutorial: failure assessment of a coastal dyke'
output:
  html_document:
    df_print: paged
...
This is an R Markdown Notebook to help you through the R package [hyriskR](https://github.com/anrhouses/hyriskR).
...
This can be done using the *summmary_1cdf* function as follows using two aversion weight values of respectively 30 and 50$\%$.
